...
// register widgets
if (!function_exists('zopit_social_icon_register')) {
    function zopit_social_icon_register() {
        register_widget('zopit_Social_Widget');
    }

    add_action('widgets_init', 'zopit_social_icon_register');
}
...
class zopit_Social_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'zopit_social_button', // Base ID
            esc_html__('zopit Social Icons', 'zopit'), // Name
            array('description' => esc_html__('Displaying social icons', 'zopit'),) // Args
        );
    }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title :', 'zopit');
                ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Enter facebook URL:', 'zopit');
                ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Enter twitter URL:', 'zopit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Enter google URL:', 'zopit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Enter pinterest URL:', 'zopit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('dribbble')); ?>"><?php esc_html_e('Enter dribbble URL:', 'zopit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('behance')); ?>"><?php esc_html_e('Enter behance URL:', 'zopit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php esc_html_e('Enter youtube URL:', 'zopit'); ?></label>
    ...
    {
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Social Icons', 'zopit') :
